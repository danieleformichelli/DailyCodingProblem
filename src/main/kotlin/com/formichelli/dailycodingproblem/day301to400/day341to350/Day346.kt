package com.formichelli.dailycodingproblem.day301to400.day341to350
...
*/
object Day346 {
    data class Flight(val from: String, val to: String, val price: Int)

    fun solution(flights: List<Flight>, from: String, to: String, maxSteps: Int): Int {
