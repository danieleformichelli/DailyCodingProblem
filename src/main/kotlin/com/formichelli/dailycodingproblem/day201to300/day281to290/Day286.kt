package com.formichelli.dailycodingproblem.day201to300.day281to290
...
*/
object Day286 {
    data class Building(val left: Int, val right: Int, val height: Int)

    fun solution(buildings: List<Building>): List<Pair<Int, Int>> {
